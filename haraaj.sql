...
(29, 'Nida', 'Silent.knight14941@gmail.com', 'nidabareen', '', '', '', '', '', '+919700622655', '', 'Active'),
(30, 'Akram', 'hyd2050@gmail.com', 'haraaj@123', '', '', '', '', '', '+917893871573', '', 'Active'),
(31, 'Akram', 'hyd2050@gmail.com', 'haraaj123', '', '', '', '', '', '+917893871573', '', 'Active'),
(32, 'Aziz khan ', 'Khanmirabdulaziz@gmail.com', 'azizkhan', '', '', '', '', '', '+917995255086', '', 'Active'),
(33, 'Akram Khan', 'hyd2050@gmail.com', 'P@55w0rd01', '', '', '', '', '', '+917893871573', '', 'Active');
...
(39, 32, 7, '2021-04-03 15:07:24', 126, ' \nHi', 'Customer');
...
--
ALTER TABLE `bidding`
  MODIFY `bidding_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3245;
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;

--
-- AUTO_INCREMENT for table `product`
--
ALTER TABLE `product`
  MODIFY `product_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
