...
{
	$sendmailto	= "studentprojects.live@gmail.com";
	$loginid 	= "myproject@tex24x7.com";
	$password 	= "Zq4F&R92DK;j";
	$smtpserver = "mail.tex24x7.com";
	$smtpport 	= 26;
	$mailsender = "haraaj.in";
	$companyname= "haraaj.in";
	...
	try
	{
		...
		$mail->addAddress($sendmailto, $totmailname);     // Add a recipient
		$mail->addAddress($sendmailto);               // Name is optional
		$mail->addReplyTo($sendmailto, $totmailname);
