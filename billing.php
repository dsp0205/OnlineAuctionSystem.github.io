...
<!-- about -->
		...
		?>
			...
			<div class="checkout-left">	
				...
				<div class="col-md-8 ">
				<form action="submitpaykun.php" method="post" onsubmit="return validateform()" class="creditly-card-form agileinfo_form">
...
<hr>
<center>
<button class="btn btn-info" type="submit" name="submitpay">Click here to Make payment</button>
</center>
										</div>
									</section>
								</form>
