...
?>
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="Terms.php#Refund">Refund & Cancellations </a></li>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> HARAAJ.IN </p> 
                                                    <p> A subsidiary of M/s REGAL COMMERCIAL SERVICES </p>
                                                    <Li> </Li>
                                                    <p> Registered Address: </p>
                                                <p> Flat No. 301, Unity Homes, Punjagutta, </p> 
                                                <p> Hyderabad-500082.<br>India</p>
                                                <p>Call us: <span>+91-7893871573 </span></p>
                                                <p>Email us: <span>info@haraaj.in</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; haraaj.in. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
