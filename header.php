...
//error_reporting(0);
$slider  = 0; //To Enable Slider Type 1 | To disable Slider Type 0
//default_time_stamp();
...
<div class="top-dropdown">
	...
	?>
		...
		<li><a href="messagebox.php" style="width: 15px;">Message Box</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>+91-7893871573 </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
				...
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							<h1 class="title1"><span class="text">Haraaj..</span></h1>
